...
VALIDSESSION=$(curl -s "https://adventofcode.com/2019/day/1/input" --cookie "session=${AOC_SESSION}")
...
curl -s "https://adventofcode.com/2019/day/${day}/input" --cookie "session=${AOC_SESSION}" -o input.txt
